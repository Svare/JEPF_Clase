...
//  Practica # 11 Animación por Keyframes                                 ////
...
float posX = 0, posY = 2.5, posZ = +-3.5,
		rotRodIzq = 0, rotBrIzq = 0,
		rotRodDer = 0, rotBrDer = 0;
...
void interpolation ( void )
{
	...
	KeyFrame[playIndex].rotBrIzqInc = (KeyFrame[playIndex + 1].rotBrIzq - KeyFrame[playIndex].rotBrIzq) / i_max_steps;

	KeyFrame[playIndex].rotBrDerInc = (KeyFrame[playIndex + 1].rotBrDer - KeyFrame[playIndex].rotBrDer) / i_max_steps;
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
    ...
    text1.LoadBMP((char *)"01.bmp");
	text1.BuildGLTexture();
	text1.ReleaseImage();

	text2.LoadBMP((char *)"logopumas.bmp");
	text2.BuildGLTexture();
	text2.ReleaseImage();

	text3.LoadTGA((char *)"city/arrow.tga");
	text3.BuildGLTexture();
	text3.ReleaseImage();

	text4.LoadTGA((char *)"city/pavimento.tga");
	text4.BuildGLTexture();
	text4.ReleaseImage();

	text5.LoadTGA((char *)"city/pasto01.tga");
	text5.BuildGLTexture();
	text5.ReleaseImage();

	text6.LoadTGA((char *)"city/casa01.tga");
	...
	for(int i=0; i<MAX_FRAMES; i++)
	{
		...
		KeyFrame[i].rotBrIzqInc = 0;

		KeyFrame[i].rotBrDer = 0;
		KeyFrame[i].rotBrDerInc = 0;
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glPopMatrix();
		...
		glDisable(GL_LIGHTING);
			...
			pintaTexto(-11,12.0,-14.0,(void *)font, (char *)"Practica 11");
...
void animacion()
{
	...
	{		
		...
		else
		{
			...
			rotBrIzq += KeyFrame[playIndex].rotBrIzqInc;

			rotBrDer += KeyFrame[playIndex].rotBrDerInc;
