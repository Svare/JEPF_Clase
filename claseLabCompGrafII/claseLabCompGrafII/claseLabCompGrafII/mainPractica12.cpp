...
enum dirCarro {DERECHA1, ARRIBA, DIAGONAL, DERECHA2, STOP};
enum dirCarro edoPresente,edoSiguiente;
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	edoPresente = DERECHA1;
	edoSiguiente = DERECHA1;
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glRotatef(g_lookupdown,1.0f,0,0);
		...
		glPushMatrix();		
			...
			glPushMatrix();
				glRotatef(90, 0, 1, 0); // Esta rotacion rota mis ejes
	...
	if (flagCircuito) {
		...
		switch(edoPresente) {
			...
			case DIAGONAL:
				rotKit = 202.0;
				movKitX--;
				movKitZ = movKitZ - 2.48;
				if (movKitX <= 0.0)
					edoSiguiente = DERECHA2;
				else
					edoSiguiente = DIAGONAL;
				break;
			case DERECHA2:
